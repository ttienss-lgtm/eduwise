...
const FEATURES = [
    ...
    { icon: Sparkles, title: 'AI Tư vấn Thông minh', desc: 'Gợi ý thành phố, ngành học, trường phù hợp tại Úc dựa trên profile cá nhân hóa', color: 'var(--purple)', bg: 'var(--purple-bg)' },
    { icon: GraduationCap, title: 'Chọn Trường Chính xác', desc: 'Database 50+ trường Úc, Group of Eight, phân tầng Reach/Match/Safety, so sánh side-by-side', color: 'var(--B500)', bg: 'var(--B50)' },
    { icon: Users, title: 'Tư vấn viên Chuyên nghiệp', desc: 'Kết nối cựu du học sinh tại Úc, đặt lịch 1-1, gói mentoring linh hoạt', color: 'var(--orange)', bg: 'var(--orange-bg)' },
    { icon: Map, title: 'Roadmap Cá nhân hóa', desc: 'Gap analysis, timeline 6-24 tháng, milestones cụ thể cho hành trình du học Úc', color: 'var(--green)', bg: 'var(--green-bg)' },
    { icon: Shield, title: 'Visa & Hồ sơ Trọn gói', desc: 'Step-by-step Subclass 500, 485, PR pathway 189/190/491, checklist giấy tờ, GTE guide', color: 'var(--red)', bg: 'var(--red-bg)' },
]

const STATS = [
    { number: '50+', label: 'Trường tại Úc' },
    { number: '50+', label: 'Tư vấn viên' },
    { number: '6', label: 'Thành phố lớn' },
        ...
        <div className="landing">
            ...
            <section className="hero">
                <div className="hero-content">
                    <div className="hero-badge"><Star size={14} />Nền tảng du học Úc #1 cho sinh viên Việt Nam</div>
                    <h1 className="hero-title">Hiểu bản thân.<br /><span>Chọn đúng trường tại Úc.</span><br />Đi đúng đường.</h1>
                    <p className="hero-desc">EduWise giúp bạn đánh giá năng lực toàn diện, chọn trường phù hợp tại Úc, kết nối với chuyên gia tư vấn, và lên kế hoạch du học cá nhân hóa — hoàn toàn miễn phí.</p>
                ...
                <div className="hero-visual">
                    <div className="hero-visual-inner">
                        ...
                        <div className="hero-visual-card">
                            <Map size={20} style={{ color: 'var(--green)' }} /><div><div style={{ fontWeight: 600, fontSize: 14 }}>Roadmap: 18 tháng</div><div style={{ fontSize: 12, color: 'var(--N500)' }}>IELTS 6.5 → Apply → Visa Úc</div></div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="landing-section" id="features">
                <div className="section-header">
                    <h2>Tất cả những gì bạn cần cho hành trình du học Úc</h2>
                    <p>Từ đánh giá năng lực đến chọn trường tại Úc — EduWise đồng hành cùng bạn từng bước</p>
                </div>
            ...
            <section className="landing-cta" id="cta">
                <h2>Sẵn sàng khám phá tiềm năng du học Úc?</h2>
            ...
            <footer className="landing-footer">© 2026 EduWise. All rights reserved. — Du học Úc: Hiểu bản thân. Chọn đúng trường. Đi đúng đường.</footer>
        </div>
    )
}
